...
1) Open your terminal or command prompt in the directory and run the app setup script directly with the command ' py -3.11 app.py '. This will trigger its automated setup sequence. (Note: WhisperX requires a Python version >=3.10 or <3.14. When running this command, substitute '3.11' with your Python version. Using Python 3.14 will cause the system to only partially install the whisperx environment.)
